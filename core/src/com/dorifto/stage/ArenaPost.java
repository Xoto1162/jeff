...
public class ArenaPost extends LevelStage {
	...
	public void draw() {
		...
		batch.begin();
		font.draw(batch, "Merci d'avoir joué ! Appuyez sur A pour quitter le jeu", Gdx.graphics.getWidth()/3.0f, Gdx.graphics.getHeight()/3.0f - font.getLineHeight());
