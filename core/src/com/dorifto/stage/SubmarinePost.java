...
public class SubmarinePost extends LevelStage {
	...
	public void draw() {
		...
		batch.begin();
		font.draw(batch, "le gagnant est le joueur "+winner.getPlayerColor(), Gdx.graphics.getWidth()/3.0f, Gdx.graphics.getHeight()/3.0f);
		font.getData().setScale(2.0f);
		batch.end();
		
		batch.begin();
		font.draw(batch, "Appuyez sur A pour Continuer", Gdx.graphics.getWidth()/3.0f, Gdx.graphics.getHeight()/3.0f - font.getLineHeight());
